...
| ![Simple light sensor board Image](https://solde.red/333046/image) |
| :----------------------------------------------------------: |
...
This repository contains all design files for Simple light sensor board, organized as follows:
